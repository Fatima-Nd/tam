...
export class Dropdown extends Component {
    ...
    renderKeyboardHelper() {
        return <div className="p-hidden-accessible">
            <input ref={(el) => this.focusInput = el} id={this.props.inputId} type="text" readOnly aria-haspopup="listbox" placeholder={this.props.placeholder}
            ...
            return (
                <div className="p-dropdown-header">
                    <div className="p-dropdown-filter-container">
                        <input autoFocus ref={(el) => this.filterInput = el} type="text" autoComplete="off" className="p-dropdown-filter p-inputtext p-component" placeholder={this.props.filterPlaceholder}
